...
/*
Lê 2 valores no vetor A, soma 2 a cada valor e armazena no vetor B. Ordena B e permite ao usuário pesquisar valores dentro do vetor.
*/
...
int main(void){
	...
	qsort(vetorB, 2, sizeof(int), comparar);
	pesquisar(vetorB,2);
}
